...
import { FileEdit, PlusCircle, MinusCircle, Copy, Check, ChevronDown, ChevronUp } from "lucide-react"
...
export function GitHubDiffView({ type, sectionName, currentContent, recommendedContent, explanation }: DiffViewProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      {isOpen && (
        <>
          {/* Explanation */}
          <div className="p-3 text-sm text-gray-700 border-t border-gray-100">{explanation}</div>
          ...
          {type === "update" && currentContent && recommendedContent && (
            <div className="text-sm font-mono">
              ...
              <div className="bg-red-50 p-3 border-t border-red-100">
                <div className="flex">
                  <div className="text-red-700 w-8 flex-shrink-0 select-none">-</div>
                  <div className="text-red-900 whitespace-pre-wrap">{currentContent}</div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-3 border-t border-green-100">
                <div className="flex">
                  <div className="text-green-700 w-8 flex-shrink-0 select-none">+</div>
                  <div className="text-green-900 whitespace-pre-wrap">{recommendedContent}</div>
                </div>
              </div>
            </div>
          )}

...
import { CheckCircle, PlusCircle, MinusCircle, Info } from "lucide-react"
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-4">
          ...
          <TabsContent value="overview" className="mt-4">
            <Alert>
              ...
              <AlertDescription className="mt-2">{analysisData.overallAssessment}</AlertDescription>
            </Alert>
            ...
            <Accordion type="single" collapsible className="w-full">
              {analysisData.sectionsToUpdate.map((section, index) => (
                <AccordionItem key={index} value={`update-${index}`}>
                  <AccordionTrigger className="hover:bg-gray-50 px-4 py-2 rounded-md flex-wrap">
              ...
              {analysisData.sectionsToUpdate.length === 0 && (
                <div className="text-center py-8 text-gray-500">No sections to update</div>
              )}
            </Accordion>
          </TabsContent>
          ...
          <TabsContent value="additions" className="mt-4">
            <Accordion type="single" collapsible className="w-full">
              ...
              {analysisData.sectionsToAdd.length === 0 && (
                <div className="text-center py-8 text-gray-500">No sections to add</div>
              )}
            </Accordion>
          </TabsContent>
          ...
          <TabsContent value="removals" className="mt-4">
            <Accordion type="single" collapsible className="w-full">
              ...
              {analysisData.sectionsToRemove.length === 0 && (
                <div className="text-center py-8 text-gray-500">No sections to remove</div>
              )}
            </Accordion>
          </TabsContent>
        </Tabs>
